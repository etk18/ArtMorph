      ...
      <header className="sticky top-0 z-40 border-b border-[var(--border)] bg-[var(--bg)]/80 backdrop-blur-lg">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6">
          ...
          <nav className="hidden items-center gap-1 text-sm md:flex">
            <Link
              href="/dashboard"
              className={`button button-ghost ${isActive("/dashboard") ? "bg-[var(--bg-elevated)]" : ""}`}
            >
              Dashboard
            </Link>
            <Link
              href="/create"
              className={`button button-ghost ${isActive("/create") ? "bg-[var(--bg-elevated)]" : ""}`}
            >
              Create
            </Link>
            <Link
              href="/styles"
              className={`button button-ghost ${isActive("/styles") ? "bg-[var(--bg-elevated)]" : ""}`}
            >
              Styles
            </Link>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                {isDevMode ? (
                  ...
                  <Code2 size={20} className="text-aurora-500" />
                )}
